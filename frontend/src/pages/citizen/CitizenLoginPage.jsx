...
const CitizenLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Top accent bar — sky for Citizen role */}
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="bg-[#1a3a6b] px-6 py-4">
              ...
              <p className="text-xs text-blue-300 mt-0.5">Access government services and submit complaints</p>
            </div>
            ...
            <div className="px-6 py-6">
              ...
              <p className="mt-5 text-center text-xs text-gray-500">
                ...
                <Link to="/citizen/register" className="text-[#1a3a6b] font-semibold hover:underline">
                  Register here
                </Link>
              </p>
            </div>
