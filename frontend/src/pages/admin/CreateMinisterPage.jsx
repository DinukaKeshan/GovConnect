...
const CreateMinisterPage = () => {
  ...
  const handleRegisterMinister = async (e) => {
    ...
    try {
      ...
      setSuccess('Minister account has been registered successfully.');
      setName(''); setEmail(''); setPassword(''); setDepartment('');
    } catch (err) {
      setError(err.response?.data?.error || 'Failed to register minister. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#1a3a6b] text-white">
        <div className="max-w-screen-xl mx-auto px-6 py-8">
          ...
          <h1 className="text-2xl font-bold text-white">Register Minister</h1>
          <p className="text-blue-200 text-sm mt-1">
            Create a ministerial account and assign it to a government department.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-8">
        <div className="max-w-2xl">
          ...
          <form onSubmit={handleRegisterMinister} noValidate>
              ...
              <div className="px-5 py-5 grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Hon. Ranil Perera"
                    value={name}
              ...
              <div className="px-5 py-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs text-gray-400">
                    The minister will oversee all complaints and operations within the selected department.
                  </p>
                </div>
